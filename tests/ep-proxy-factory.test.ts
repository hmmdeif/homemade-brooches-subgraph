...
import { handleCreated } from "../src/ep-proxy-factory"
import { createCreatedEvent } from "./ep-proxy-factory-utils"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newCreatedEvent = createCreatedEvent(sender, owner, proxy)
